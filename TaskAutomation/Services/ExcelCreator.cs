...
namespace TaskAutomation.Services
{
    public class ExcelCreator
    {
        ...
        private static void CreateHeaderRow (Models.Task task, Sheet sheet)
        {
        ...
        private static void WriteMainDataObject(Sheet workSheet, int numRow, Models.Object obj)
        {
        ...
        private static void WriteMainDataParameter(Sheet workSheet, ref int numRow, Models.Parameter parameter, ref int countRowsObj, ref int countRowsArea)
        {
        ...
        private static void WriteSignalingsData(Sheet workSheet, int numRow, Models.Parameter parameter)
        {
        ...
        private static void SetSignaling(Sheet workSheet, int numRow, ObservableCollection<Signaling> signalings, TypeSignaling type)
        {
        ...
        private void MergeCellsObject(Sheet workSheet, int numRow, int count)
        {
        ...
        private void MergeCells(Sheet workSheet, int count, int numRow, int numCol)
        {
